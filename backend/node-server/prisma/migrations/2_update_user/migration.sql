...
-- AddForeignKey
ALTER TABLE "comment" ADD CONSTRAINT "comment_rep_id_fkey" FOREIGN KEY ("rep_id") REFERENCES "comment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "interact" ADD CONSTRAINT "interact_react_fkey" FOREIGN KEY ("react") REFERENCES "reaction"("name") ON DELETE CASCADE ON UPDATE CASCADE;

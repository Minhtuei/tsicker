...
export function DetailPost() {
    ...
    const FOLLOWERS = 13400;
    const POST_USER = "Anh Muốn Đấm Bé";
    const COMMENT = [
        {
        ...
        },
        {
            ...
            name: "Minh Tuệ",
            comment:
                "lindo Adorei queria fazer um mas não sei como fazerlindo Adorei queria fazer um mas não sei como fazer",
            date: "2 hours ago",
        },
        {
            avatar: "https://i.pravatar.cc/300",
    ...
    return (
        <Card className="w-full max-w-[64rem] flex-row rounded-2xl shadow-xl">
            ...
            >
                <img
                    src="slides/slide_2_7.jpg"
                    alt="card-image"
                    className="object-cover object-center w-full"
                    onLoad={(event) => setMaxHeight(event.target.offsetHeight)}
                />
            </CardHeader>
            <div className="flex flex-col w-full h-full rounded-tr-2xl">
                ...
                <div className="sticky bottom-0 z-10 flex flex-col w-full px-8 py-2 bg-white border-t rounded-br-2xl">
                    <div className="flex items-center justify-between">
